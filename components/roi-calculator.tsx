...
export function RoiCalculator() {
  ...
  const savedHours = Math.floor(orders * 0.15); // Assume AI saves 0.15 hours per order (support, logistics)
  const savedCost = Math.floor(supportCost * 0.65); // AI handles 65% of L1/L2 support
  const revenueIncrease = Math.floor(orders * 150 * 0.12); // Assume average order value of 150 SAR and a 12% boost in volume
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            <div className="glass-dark p-8 rtl:border-r-4 ltr:border-l-4 rtl:border-r-[#165DFF] ltr:border-l-[#165DFF] border-none flex flex-col items-start relative overflow-hidden transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="glass-dark p-8 md:col-span-2 rtl:border-r-4 ltr:border-l-4 rtl:border-r-white/20 ltr:border-l-white/20 border-none flex flex-col items-start relative overflow-hidden transition-all duration-300 hover:scale-[1.02]">
